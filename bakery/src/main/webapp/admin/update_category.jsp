...
<%
    ...
    if (id == null || id.isEmpty()) {
        response.sendRedirect("all_category.jsp");
        return;
    }
    ...
    <div class="form-container">
        ...
        <form action="../update_category" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" id="id" name="id" value="<%=category.getId() %>" readonly />
            </div>

            <div>
                <label for="category">Tên danh mục:</label>
                <input type="text" id="category" name="category" value="<%=category.getName() %>" />
            </div>

<%--             <div>
                <label for="thumbnail">Hình ảnh:</label>
                <input type="file" id="thumbnail" name="thumbnail" accept="image/*" value=" <%=category.getThumbnail() %>" />
            </div>  --%>
